...
test('wide masthead evidence cannot steal a source-aligned column continuation', () => {
  const normalized = extraction.normalizeBasicPdfTextRects([
    { content: 'wide header 1', rect: rect(0, 0, 120, 10) },
    { content: 'wide header 2', rect: rect(0, 20, 120, 10) },
    { content: 'wide header 3', rect: rect(0, 40, 120, 10) },
    { content: 'left section', rect: rect(0, 80, 50, 10) },
    { content: 'left body', rect: rect(0, 110, 50, 10) },
    { content: 'right continuation 1', rect: rect(70, 80, 50, 10) },
    { content: 'right continuation 2', rect: rect(70, 97, 50, 10) },
    { content: 'right continuation 3', rect: rect(70, 114, 50, 10) },
  ]);
  ...
  assert.deepEqual(normalized.map(item => item.content), [
    ...
    'left section',
    'left body',
    'right continuation 1',
    'right continuation 2',
    'right continuation 3',
  ]);
});

test('a wrapped vector equation keeps arrows, symbols, and subscripts in source order', () => {
  const normalized = extraction.normalizeBasicPdfTextRects([
    { content: 'states ', rect: rect(0, 10, 24, 12) },
    { content: '(', rect: rect(29, 11, 5, 11) },
    { content: '→', rect: rect(34, 4, 11, 8) },
    { content: 'h', rect: rect(36, 12, 6, 10) },
    { content: '1', rect: rect(45, 16, 4, 6) },
    { content: ', ...,', rect: rect(49, 12, 17, 10) },
    { content: '→', rect: rect(68, 4, 11, 8) },
    { content: 'h', rect: rect(70, 12, 6, 10) },
    { content: 'm', rect: rect(79, 16, 7, 7) },
    { content: '), and a backward sequence', rect: rect(91, 10, 126, 12) },
    { content: '(', rect: rect(0, 28, 4, 11) },
    { content: '←', rect: rect(4, 20, 11, 8) },
    { content: 'h', rect: rect(7, 28, 6, 10) },
    { content: '1', rect: rect(16, 32, 4, 6) },
    { content: ', ...,', rect: rect(21, 28, 17, 10) },
    { content: '←', rect: rect(39, 20, 11, 8) },
    { content: 'h', rect: rect(42, 28, 6, 10) },
    { content: 'm', rect: rect(51, 32, 7, 7) },
    { content: '). The hidden states', rect: rect(59, 26, 84, 13) },
    { content: 'continue in prose.', rect: rect(0, 44, 90, 12) },
  ]);

  assert.deepEqual(normalized.map(item => item.content), [
    'states ', '(', '→', 'h', '1', ', ...,', '→', 'h', 'm',
    '), and a backward sequence', '(', '←', 'h', '1', ', ...,', '←', 'h', 'm',
    '). The hidden states', 'continue in prose.',
  ]);
});

test('a display fraction keeps its numerator, denominator, and equation number together', () => {
  const normalized = extraction.normalizeBasicPdfTextRects([
    { content: 'The preference probability is ', rect: rect(0, 0, 120, 12) },
    { content: 'p* =', rect: rect(124, 0, 24, 12) },
    { content: 'exp(r*(x, y1))', rect: rect(154, -7, 66, 9) },
    { content: 'exp(r*(x, y1)) + exp(r*(x, y2))', rect: rect(150, 9, 146, 9) },
    { content: '.', rect: rect(300, 0, 3, 12) },
    { content: '(1)', rect: rect(330, 0, 16, 12) },
    { content: 'Assuming access to comparisons,', rect: rect(0, 26, 150, 12) },
    { content: 'we estimate the reward by maximum likelihood.', rect: rect(0, 40, 210, 12) },
  ]);
  ...
  assert.deepEqual(normalized.map(item => item.content), [
    ...
    '.',
    '(1)',
    'Assuming access to comparisons,',
    'we estimate the reward by maximum likelihood.',
  ]);
});

test('a fragmented display equation stays between its introducing and following prose', () => {
  const source = [
    { content: 'framework before the equation', rect: rect(0, 0, 393, 12) },
    { content: 'preference distribution ', rect: rect(0, 11, 89, 12) },
    { content: 'p', rect: rect(92, 13, 6, 10) },
    { content: '*', rect: rect(98, 11, 4, 12) },
    { content: ' can be written as:', rect: rect(105, 11, 69, 12) },
    { content: 'p', rect: rect(90, 36, 5, 10) },
    { content: '*', rect: rect(95, 34, 4, 12) },
    { content: '(y1 > y2 | x) =', rect: rect(99, 36, 64, 10) },
    { content: 'exp(', rect: rect(203, 29, 21, 10) },
    { content: 'r', rect: rect(224, 29, 5, 10) },
    { content: '*', rect: rect(229, 28, 4, 12) },
    { content: '(x, y', rect: rect(233, 29, 22, 10) },
    { content: '1', rect: rect(255, 33, 4, 7) },
    { content: '))', rect: rect(260, 29, 8, 10) },
    { content: 'exp(', rect: rect(167, 43, 20, 10) },
    { content: 'r', rect: rect(187, 43, 5, 10) },
    { content: '*', rect: rect(192, 42, 4, 12) },
    { content: '(x, y', rect: rect(196, 43, 22, 10) },
    { content: '1', rect: rect(218, 47, 4, 7) },
    { content: ')) + exp(', rect: rect(223, 43, 41, 10) },
    { content: 'r', rect: rect(264, 43, 4, 10) },
    { content: '*', rect: rect(268, 42, 4, 12) },
    { content: '(x, y', rect: rect(272, 43, 22, 10) },
    { content: '2', rect: rect(294, 47, 4, 7) },
    { content: '))', rect: rect(298, 43, 8, 10) },
    { content: '.', rect: rect(301, 36, 3, 10) },
    { content: '(1)', rect: rect(383, 34, 12, 12) },
    { content: 'Assuming access to comparisons ', rect: rect(0, 61, 204, 12) },
    { content: 'D', rect: rect(208, 63, 7, 17) },
    { content: '= sampled preferences, we', rect: rect(218, 63, 176, 12) },
    { content: 'can parametrize a reward model.', rect: rect(0, 73, 180, 12) },
  ];
  const normalized = extraction.normalizeBasicPdfTextRects(source);

  assert.deepEqual(
    normalized.map(item => item.content),
    source.map(item => item.content),
  );
});

test('a wrapped inline formula keeps its subscripted variables before the next prose line', () => {
  const normalized = extraction.normalizeBasicPdfTextRects([
    { content: 'Each word ', rect: rect(0, 0, 48, 12) },
    { content: 'y', rect: rect(50, 2, 6, 10) },
    { content: 'i', rect: rect(56, 6, 3, 6) },
    { content: ' depends on ', rect: rect(62, 0, 58, 12) },
    { content: 'y', rect: rect(122, 2, 6, 10) },
    { content: 'i−1', rect: rect(128, 6, 14, 6) },
    { content: ' and context ', rect: rect(145, 0, 64, 12) },
    { content: 'c', rect: rect(211, 2, 5, 10) },
    { content: 'i', rect: rect(216, 6, 3, 6) },
    { content: '.', rect: rect(220, 0, 3, 12) },
    { content: 'The alignment model follows.', rect: rect(0, 16, 130, 12) },
  ]);

  assert.deepEqual(normalized.map(item => item.content), [
    'Each word ', 'y', 'i', ' depends on ', 'y', 'i−1', ' and context ', 'c', 'i', '.',
    'The alignment model follows.',
  ]);
});

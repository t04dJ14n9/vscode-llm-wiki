...
export function hybridStyles() {
  return EditorView.baseTheme({
    ...
    '.cm-hybrid-callout': {
      ...
      borderLeft: '0',
      borderRadius: '4px',
      backgroundColor: 'color-mix(in srgb, var(--llm-wiki-callout-color) 12%, transparent)',
      color: 'var(--vscode-editor-foreground)',
    },
    ...
    '.cm-hybrid-callout-abstract, .cm-hybrid-callout-summary, .cm-hybrid-callout-tldr, .cm-hybrid-callout-info, .cm-hybrid-callout-todo': {
      '--llm-wiki-callout-color': 'var(--vscode-charts-cyan, var(--vscode-textLink-foreground, var(--vscode-editor-foreground)))',
    },
    '.cm-hybrid-callout-tip, .cm-hybrid-callout-hint, .cm-hybrid-callout-important': {
      '--llm-wiki-callout-color': 'var(--vscode-charts-green, var(--vscode-editorInfo-foreground, var(--vscode-editor-foreground)))',
    },
    '.cm-hybrid-callout-success, .cm-hybrid-callout-check, .cm-hybrid-callout-done': {
      '--llm-wiki-callout-color': 'var(--vscode-testing-iconPassed, var(--vscode-charts-green, var(--vscode-editor-foreground)))',
    },
    '.cm-hybrid-callout-question, .cm-hybrid-callout-help, .cm-hybrid-callout-faq': {
      '--llm-wiki-callout-color': 'var(--vscode-charts-yellow, var(--vscode-editorWarning-foreground, var(--vscode-editor-foreground)))',
    },
    '.cm-hybrid-callout-warning, .cm-hybrid-callout-caution, .cm-hybrid-callout-attention': {
      '--llm-wiki-callout-color': 'var(--vscode-editorWarning-foreground, var(--vscode-editor-foreground))',
    },
    '.cm-hybrid-callout-failure, .cm-hybrid-callout-fail, .cm-hybrid-callout-missing, .cm-hybrid-callout-danger, .cm-hybrid-callout-error, .cm-hybrid-callout-bug': {
      '--llm-wiki-callout-color': 'var(--vscode-errorForeground, var(--vscode-editor-foreground))',
    },
    '.cm-hybrid-callout-example': {
      '--llm-wiki-callout-color': 'var(--vscode-charts-purple, var(--vscode-textLink-foreground, var(--vscode-editor-foreground)))',
    },
    '.cm-hybrid-callout-quote, .cm-hybrid-callout-cite': {
      '--llm-wiki-callout-color': 'var(--vscode-descriptionForeground, var(--vscode-editor-foreground))',
    },
    '.cm-hybrid-callout-title': {
      ...
      marginBottom: '0.45em',
      fontWeight: '700',
      color: 'var(--llm-wiki-callout-color)',
    },
    ...
    '&': {
      '--llm-wiki-codeblock-background': 'var(--vscode-textCodeBlock-background, rgba(127, 127, 127, 0.10))',
      '--llm-wiki-code-token-comment': 'var(--vscode-descriptionForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-keyword': 'var(--vscode-symbolIcon-keywordForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-string': 'var(--vscode-symbolIcon-stringForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-function': 'var(--vscode-symbolIcon-functionForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-number': 'var(--vscode-symbolIcon-numberForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-boolean': 'var(--vscode-symbolIcon-booleanForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-operator': 'var(--vscode-symbolIcon-operatorForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-punctuation': 'var(--vscode-descriptionForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-type': 'var(--vscode-symbolIcon-classForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-namespace': 'var(--vscode-symbolIcon-namespaceForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-property': 'var(--vscode-symbolIcon-propertyForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-variable': 'var(--vscode-symbolIcon-variableForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-regex': 'var(--vscode-symbolIcon-stringForeground, var(--vscode-editor-foreground))',
      '--llm-wiki-code-token-tag': 'var(--vscode-symbolIcon-keywordForeground, var(--vscode-editor-foreground))',
    },
    '.cm-hybrid-codeblock': {
      display: 'block',
      height: '1lh',
    ...
    '.cm-hybrid-prism-token.token.comment, .cm-hybrid-prism-token.token.prolog, .cm-hybrid-prism-token.token.doctype, .cm-hybrid-prism-token.token.cdata': {
      color: 'var(--llm-wiki-code-token-comment)',
    },
    '.cm-hybrid-prism-token.token.keyword, .cm-hybrid-prism-token.token.atrule': {
      color: 'var(--llm-wiki-code-token-keyword)',
    },

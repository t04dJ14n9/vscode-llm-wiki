...
relations: [{"target": "entities/datacomp-lm.md", "kind": "references", "caption": "DataComp-LM"}, {"target": "concepts/pretraining-data-curation.md", "kind": "references", "caption": "Pretraining data curation"}, {"target": "comparisons/fineweb-vs-datacomp-lm.md", "kind": "references", "caption": "FineWeb versus DataComp-LM"}, {"target": "summaries/research-corpus-overview.md", "kind": "applies-to", "caption": "Places FineWeb in the demo's broader research corpus"}]
---

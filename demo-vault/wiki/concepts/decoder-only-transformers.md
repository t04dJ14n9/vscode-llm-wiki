...
relations: [{"target": "concepts/grouped-query-attention.md", "kind": "references", "caption": "grouped-query attention"}, {"target": "concepts/kv-caching.md", "kind": "references", "caption": "KV caching"}, {"target": "concepts/rotary-position-embeddings.md", "kind": "references", "caption": "Rotary position embeddings"}]
---

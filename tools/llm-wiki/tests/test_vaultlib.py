...
class VaultlibTests(unittest.TestCase):
    ...
    def test_markdown_targets_ignore_inline_code_examples(self) -> None:
        body = "Use `[[tool.uv.index]]` and ``[fake](missing.md)`` literally."
        self.assertEqual(markdown_targets(body), ())

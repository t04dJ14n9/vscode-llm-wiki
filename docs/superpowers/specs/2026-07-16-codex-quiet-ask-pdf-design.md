...
- Changing the PDF discussion schema, sidecar storage, Codex app-server protocol, host/webview protocol, or promotion model.
...
- The Send action occupies one consistent location and becomes **Stop** during a running turn.
...
5. Minimize and restore the annotation-owned chip.
6. Close and reopen the PDF and confirm the discussion and window state restore.
7. Ask a follow-up and promote the discussion to a normal Codex task.
8. Repeat the critical open/ask/minimize flow in the standalone PDF extension.
